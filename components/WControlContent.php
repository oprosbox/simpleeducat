...
class WControlContent{
    ...
    public function set_params($params) {
        if (!empty(self::$params['id_item']) || self::$params['id_item'] == null) {
        ...
        if (!empty(self::$params['id_channel']) || self::$params['id_channel'] == null) {
            self::$params['id_channel'] = null;
            self::$params['id_playlist'] = null;
            self::$params['id_video'] = null;
            return;
        }
        if (!empty(self::$params['id_playlist']) || self::$params['id_playlist'] == null) {
            self::$params['id_playlist'] = null;
            self::$params['id_video'] = null;
            return;
        }
        if (!empty(self::$params['id_video'])) {
            self::$params['id_video'] = null;
            return;
        }
        self::$params = $params;
    ...
    protected function get_data_from_BD() {
        ...
        if ((!empty(self::$videos)) && (self::$params['id_video'] == null)) {
            ...
            self::$params['id_video'] = $key;
        }}

    static private $params;
    static private $channels;
    static private $playlists;
