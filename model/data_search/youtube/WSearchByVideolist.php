...
class WSearchByVideolist implements IStratSearch {
    ...
    public function search_content($keyword,$count=10) {
        $this->list = $this->search_base->search_by_keyword($keyword,"youtube#playlist",$count);
        $this->list->find_parent($this->search_base);
